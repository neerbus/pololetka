lokace1 = " " #sem napis lokaci souboru autori.txt
lokace2 = " " # sem napis lokaci souboru pololetka.txt
...
def hardMain(age):
    ...
    if randInt == 1:
        ...
        odpoved3 = input("Dilo: ")
        if odpoved1 == str(cont[0].replace("/", " ")) and odpoved2 == str(cont[1]) and odpoved3 == str(cont[2].replace("/", " ")):
            print("spravne")
        else:
